...
class LayoutScreen extends StatefulWidget {
  ...
  LayoutScreen({Key? key, this.screenIndex = 0, this.initialScreen = const HomeScreen(), this.previousRoute})
      : super(key: key);
...
class _LayoutScreenState extends State<LayoutScreen> {
  ...
  void onTabTap(int index) {
    if (index == 0) {
      PersistentNavBarNavigator.pushNewScreen(
        context,
        screen: LayoutScreen(
          initialScreen: HymnsProgramScreen(),
        ),
        withNavBar: true,
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    return BaseScaffold(
      ...
      scaffoldBody: Stack(children: <Widget>[
        PersistentTabView(
